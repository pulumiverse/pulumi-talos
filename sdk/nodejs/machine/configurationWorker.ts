 ...
 *     endpoints: ["10.5.0.2"],
 * });
 * const machineconfigWorker = new talos.machine.ConfigurationWorker("machineconfigWorker", {
 ...
 * ```
 */
export class ConfigurationWorker extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConfigurationWorkerState, opts?: pulumi.CustomResourceOptions): ConfigurationWorker {
        return new ConfigurationWorker(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'talos:machine/configurationWorker:ConfigurationWorker';

    /**
     * Returns true if the given object is an instance of ConfigurationWorker.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConfigurationWorker {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ConfigurationWorker.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ConfigurationWorkerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConfigurationWorkerArgs | ConfigurationWorkerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConfigurationWorkerState | undefined;
            ...
            const args = argsOrState as ConfigurationWorkerArgs | undefined;
        ...
        super(ConfigurationWorker.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ConfigurationWorkerState {
    /**
     * The endpoint of the Talos cluster
     */
 ...
 */
export interface ConfigurationWorkerArgs {
    /**
     * The endpoint of the Talos cluster
     */
    clusterEndpoint: pulumi.Input<string>;
