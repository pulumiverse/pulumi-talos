...
namespace SideroLabs.Pulumi.Talos.Machine
{
    ...
    /// ```
    /// </summary>
    [TalosResourceType("talos:machine/configurationControlplane:ConfigurationControlplane")]
    public partial class ConfigurationControlplane : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ConfigurationControlplane(string name, ConfigurationControlplaneArgs args, CustomResourceOptions? options = null)
            : base("talos:machine/configurationControlplane:ConfigurationControlplane", name, args ?? new ConfigurationControlplaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationControlplane(string name, Input<string> id, ConfigurationControlplaneState? state = null, CustomResourceOptions? options = null)
            : base("talos:machine/configurationControlplane:ConfigurationControlplane", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConfigurationControlplane Get(string name, Input<string> id, ConfigurationControlplaneState? state = null, CustomResourceOptions? options = null)
        {
            return new ConfigurationControlplane(name, id, state, options);
        }
    }

    public sealed class ConfigurationControlplaneArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The endpoint of the Talos cluster
        /// </summary>
        ...
        public ConfigurationControlplaneArgs()
        {
        }
        public static new ConfigurationControlplaneArgs Empty => new ConfigurationControlplaneArgs();
    }

    public sealed class ConfigurationControlplaneState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The endpoint of the Talos cluster
        /// </summary>
        ...
        public ConfigurationControlplaneState()
        {
        }
        public static new ConfigurationControlplaneState Empty => new ConfigurationControlplaneState();
    }
}
