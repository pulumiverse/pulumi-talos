...
class KubeconfigArgs:
    def __init__(__self__, *,
                 ...
                 certificate_renewal_duration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] node: controlplane node to retrieve the kubeconfig from
        :param pulumi.Input[builtins.str] certificate_renewal_duration: The duration in hours before the certificate is renewed, defaults to 720h. Must be a valid duration string
        :param pulumi.Input[builtins.str] endpoint: endpoint to use for the talosclient. If not set, the node value will be used
        """
    ...
    def certificate_renewal_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def certificate_renewal_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KubeconfigState:
    def __init__(__self__, *,
                 ...
                 endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 kubeconfig_raw: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['KubeconfigClientConfigurationArgs'] client_configuration: The client configuration data
        :param pulumi.Input[builtins.str] endpoint: endpoint to use for the talosclient. If not set, the node value will be used
        :param pulumi.Input[builtins.str] kubeconfig_raw: The raw kubeconfig
    ...
    def kubeconfig_raw(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The raw kubeconfig
        """
    ...
    def kubeconfig_raw(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("talos:cluster/kubeconfig:Kubeconfig")
class Kubeconfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="certificateRenewalDuration")
    def certificate_renewal_duration(self) -> pulumi.Output[builtins.str]:
        """
        The duration in hours before the certificate is renewed, defaults to 720h. Must be a valid duration string
        """
        return pulumi.get(self, "certificate_renewal_duration")
    ...
    @property
    @pulumi.getter(name="kubeconfigRaw")
    def kubeconfig_raw(self) -> pulumi.Output[builtins.str]:
        """
        The raw kubeconfig
        """
        return pulumi.get(self, "kubeconfig_raw")
