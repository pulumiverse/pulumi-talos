...
class KubeconfigKubernetesClientConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ca_certificate: The kubernetes CA certificate
        :param pulumi.Input[builtins.str] client_certificate: The kubernetes client certificate
        :param pulumi.Input[builtins.str] client_key: The kubernetes client key
        :param pulumi.Input[builtins.str] host: The kubernetes host
        """
