...
__all__ = [
    'GetImageFactoryUrlsResult',
    'AwaitableGetImageFactoryUrlsResult',
    'get_image_factory_urls',
    'get_image_factory_urls_output',
]

@pulumi.output_type
class GetImageFactoryUrlsResult:
    """
    ...
    @property
    @pulumi.getter
    def urls(self) -> 'outputs.GetImageFactoryUrlsUrlsResult':
        return pulumi.get(self, "urls")


class AwaitableGetImageFactoryUrlsResult(GetImageFactoryUrlsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetImageFactoryUrlsResult(
...
def get_image_factory_urls(architecture: Optional[str] = None,
                           platform: Optional[str] = None,
                           sbc: Optional[str] = None,
                           schematic_id: Optional[str] = None,
                           talos_version: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImageFactoryUrlsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('talos:index/getImageFactoryUrls:getImageFactoryUrls', __args__, opts=opts, typ=GetImageFactoryUrlsResult).value

    return AwaitableGetImageFactoryUrlsResult(
...
def get_image_factory_urls_output(architecture: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetImageFactoryUrlsResult]:
    """
    Generates URLs for different assets supported by the Talos image factory.
    """
    __args__ = dict()
    ...
    __args__['talosVersion'] = talos_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('talos:index/getImageFactoryUrls:getImageFactoryUrls', __args__, opts=opts, typ=GetImageFactoryUrlsResult)
    return __ret__.apply(lambda __response__: GetImageFactoryUrlsResult(
