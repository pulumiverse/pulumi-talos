...
class GetUrlsUrlsResult(dict):
    def __init__(__self__, *,
                 ...
                 disk_image_secureboot: builtins.str,
                 initramfs: builtins.str,
                 installer: builtins.str,
                 installer_secureboot: builtins.str,
                 iso: builtins.str,
                 iso_secureboot: builtins.str,
                 kernel: builtins.str,
                 kernel_command_line: builtins.str,
                 pxe: builtins.str,
                 uki: builtins.str):
        """
        :param builtins.str disk_image: The URL for the disk image.
        :param builtins.str disk_image_secureboot: The URL for the disk image with secure boot.
        :param builtins.str initramfs: The URL for the initramfs image.
        :param builtins.str installer: The URL for the installer image.
        :param builtins.str installer_secureboot: The URL for the installer image with secure boot.
        :param builtins.str iso: The URL for the ISO image.
        :param builtins.str iso_secureboot: The URL for the ISO image with secure boot.
        :param builtins.str kernel: The URL for the kernel image.
        :param builtins.str kernel_command_line: The URL for the kernel command line.
        :param builtins.str pxe: The URL for the PXE image.
        :param builtins.str uki: The URL for the UKI image.
        """
    ...
    def disk_image_secureboot(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def initramfs(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def installer(self) -> builtins.str:
        """
    ...
    def installer_secureboot(self) -> builtins.str:
        """
    ...
    def iso_secureboot(self) -> builtins.str:
        """
    ...
    def kernel_command_line(self) -> builtins.str:
        """
