...
__all__ = [
    ...
    'GetImageFactoryExtensionsVersionsFiltersArgsDict',
    'GetImageFactoryOverlaysVersionsFiltersArgs',
    'GetImageFactoryOverlaysVersionsFiltersArgsDict',
    'GetImageFactoryVersionsFiltersArgs',
    'GetImageFactoryVersionsFiltersArgsDict',
]

MYPY = False

if not MYPY:
    class GetImageFactoryExtensionsVersionsFiltersArgsDict(TypedDict):
        names: NotRequired[Sequence[str]]
        """
        The name of the extension to filter by.
        """
elif False:
    GetImageFactoryExtensionsVersionsFiltersArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GetImageFactoryExtensionsVersionsFiltersArgs:
...
if not MYPY:
    class GetImageFactoryOverlaysVersionsFiltersArgsDict(TypedDict):
        name: NotRequired[str]
        """
        The name of the overlay to filter by.
        """
elif False:
    GetImageFactoryOverlaysVersionsFiltersArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GetImageFactoryOverlaysVersionsFiltersArgs:
    def __init__(__self__, *,
...
if not MYPY:
    class GetImageFactoryVersionsFiltersArgsDict(TypedDict):
    ...
    GetImageFactoryVersionsFiltersArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GetImageFactoryVersionsFiltersArgs:
    def __init__(__self__, *,
