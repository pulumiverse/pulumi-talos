...
class GetConfigurationResult:
    ...
    def machine_secrets(self) -> 'outputs.GetConfigurationMachineSecretsResult':
        """
...
def get_configuration(cluster_endpoint: Optional[str] = None,
                      ...
                      machine_secrets: Optional[pulumi.InputType['GetConfigurationMachineSecretsArgs']] = None,
    ...
    :param pulumi.InputType['GetConfigurationMachineSecretsArgs'] machine_secrets: The secrets for the talos cluster
...
def get_configuration_output(cluster_endpoint: Optional[pulumi.Input[str]] = None,
                             ...
                             machine_secrets: Optional[pulumi.Input[pulumi.InputType['GetConfigurationMachineSecretsArgs']]] = None,
