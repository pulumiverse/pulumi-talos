...
__all__ = ['ConfigurationWorkerArgs', 'ConfigurationWorker']

@pulumi.input_type
class ConfigurationWorkerArgs:
...
@pulumi.input_type
class _ConfigurationWorkerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] examples_enabled: whether to render all machine configs with the commented examples
        :param pulumi.Input[str] kubernetes_version: desired kubernetes version to run
        :param pulumi.Input[str] machine_config: the generated worker config
        :param pulumi.Input[str] machine_secrets: The machine secrets for the cluster
        :param pulumi.Input[str] talos_version: The version of Talos for which to generate configs
        """
...
class ConfigurationWorker(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        talosconfig = talos.client.Configuration("talosconfig",
            ...
            endpoints=["10.5.0.2"])
        machineconfig_worker = talos.machine.ConfigurationWorker("machineconfigWorker",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ConfigurationWorkerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ConfigurationWorkerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ConfigurationWorkerArgs.__new__(ConfigurationWorkerArgs)
        ...
        super(ConfigurationWorker, __self__).__init__(
            'talos:machine/configurationWorker:ConfigurationWorker',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            machine_config: Optional[pulumi.Input[str]] = None,
            machine_secrets: Optional[pulumi.Input[str]] = None,
            talos_version: Optional[pulumi.Input[str]] = None) -> 'ConfigurationWorker':
        """
        ...
        __props__ = _ConfigurationWorkerState.__new__(_ConfigurationWorkerState)
        ...
        __props__.__dict__["machine_secrets"] = machine_secrets
        __props__.__dict__["talos_version"] = talos_version
        return ConfigurationWorker(resource_name, opts=opts, __props__=__props__)
