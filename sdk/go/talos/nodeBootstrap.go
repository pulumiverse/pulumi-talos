...
// node endpoint address
func (o NodeBootstrapOutput) Endpoint() pulumi.StringOutput {
	return o.ApplyT(func(v *NodeBootstrap) pulumi.StringOutput { return v.Endpoint }).(pulumi.StringOutput)
}

// node address
func (o NodeBootstrapOutput) Node() pulumi.StringOutput {
	return o.ApplyT(func(v *NodeBootstrap) pulumi.StringOutput { return v.Node }).(pulumi.StringOutput)
}

// talosconfig
func (o NodeBootstrapOutput) TalosConfig() pulumi.StringOutput {
	return o.ApplyT(func(v *NodeBootstrap) pulumi.StringOutput { return v.TalosConfig }).(pulumi.StringOutput)
}

// wait timeout in seconds
func (o NodeBootstrapOutput) Timeout() pulumi.IntOutput {
	return o.ApplyT(func(v *NodeBootstrap) pulumi.IntOutput { return v.Timeout }).(pulumi.IntOutput)
}
