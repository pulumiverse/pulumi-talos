...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			"talos_client_configuration": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getTalosClientConfiguration")},
			"talos_cluster_kubeconfig":   {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getTalosClusterKubeconfig")},
